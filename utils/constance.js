...
module.exports = {
  ...
  users: Array.from([...Array(10).keys()]).map((el) => ({
    ...
    avatar: faker.image.urlLoremFlickr({ category: "avtuser" }),
    createdAt: new Date(),
    updatedAt: new Date(),
  })),
  user_roles: [
  ...
  property: Array.from([...Array(60).keys()]).map(() => ({
    ...
    featuredImage: faker.image.urlLoremFlickr({ category: "realland" }),
    createdAt: new Date(),
    updatedAt: new Date(),
  })),
  feature: [
    {
      name: "Air condition",
      image: faker.image.urlLoremFlickr({ category: "Aircondition" }),
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
